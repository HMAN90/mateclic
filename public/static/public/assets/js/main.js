...
function cookiesPermission(){
  const acceptCookiesButton = document.getElementById('btAcceptCookies') ;
...
function checkPayment (urlCheck,urlConfirm,urlCancel){
  $.ajax({
    'url':urlCheck,
    'success':function (response){
      var responseJson = JSON.parse(response) ;
      if(responseJson.state == 'paid'){
        window.location.href= urlConfirm
      }
      else if(responseJson.state == 'canceled'){
...
function executeScript(){
  console.log('les scripts de cookies s executent')
}